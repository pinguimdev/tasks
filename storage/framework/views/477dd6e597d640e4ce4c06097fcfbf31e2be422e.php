            ...
            <div class="filters-content">
                <div class="row grid">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <?php if(auth()->guard('web')->check()): ?>
                            <?php if(isset($currentWorkspace) && $currentWorkspace->creater->id == Auth::id()): ?>
                             <div class="col-md-3 All add_projects">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/werberson/Web/projetos/task/resources/views/projects/index.blade.php ENDPATH**/ ?>