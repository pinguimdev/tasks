                    ...
                    <div class="col-xl-3">
                        <div class="card sticky-top" style="top:30px">
                            <div class="list-group list-group-flush" id="useradd-sidenav">
                                <a href="#v-pills-home" class="list-group-item list-group-item-action border-0"><?php echo e(__('Account')); ?> <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                <a href="#v-pills-profile" class="list-group-item list-group-item-action border-0"><?php echo e(__('Change Password')); ?> <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                <?php if(auth()->guard('client')->check()): ?>
                                <a href="#v-pills-billing" class="list-group-item list-group-item-action border-0"><?php echo e(__('Billing Details')); ?> <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                <?php endif; ?>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <img <?php if($user->avatar): ?> src="<?php echo e(asset('/storage/avatars/'.$user->avatar)); ?>" <?php else: ?> avatar="<?php echo e($user->name); ?>" <?php endif; ?> id="myAvatar" alt="user-image" class="rounded-circle img-thumbnail img_hight w-25">
                                                        <?php if($user->avatar!=''): ?>
                                                       <div class=" ">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/werberson/Web/projetos/task/resources/views/users/account.blade.php ENDPATH**/ ?>