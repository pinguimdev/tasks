...
<?php $__env->startSection('multiple-action-button'); ?>
    ...
    <div class="col-sm-auto  ">
        <a href="<?php echo e(route($client_keyword.'projects.timesheet.index',[$currentWorkspace->slug,$project->id])); ?>" class="btn btn-xs btn-primary btn-icon-only width-auto "><?php echo e(__('Timesheet')); ?></a>
        </div>
    <?php endif; ?>
    <?php if((isset($permissions) && in_array('show gantt',$permissions)) || (isset($currentWorkspace) && $currentWorkspace->permission == 'Owner')): ?>
     <div class="col-sm-auto  ">
        <a href="<?php echo e(route($client_keyword.'projects.gantt',[$currentWorkspace->slug,$project->id])); ?>" class="btn btn-xs btn-primary btn-icon-only width-auto "><?php echo e(__('Gantt Chart')); ?></a>
         </div>
    <?php endif; ?>
    <?php if((isset($permissions) && in_array('show task',$permissions)) || (isset($currentWorkspace) && $currentWorkspace->permission == 'Owner')): ?>
    <div class="col-sm-auto  ">
        <a href="<?php echo e(route($client_keyword.'projects.task.board',[$currentWorkspace->slug,$project->id])); ?>" class="btn btn-xs btn-primary btn-icon-only width-auto "><?php echo e(__('Task Board')); ?></a>
         </div>
    <?php endif; ?>
    <?php if((isset($permissions) && in_array('show bug report',$permissions)) || (isset($currentWorkspace) && $currentWorkspace->permission == 'Owner')): ?>
    <div class="col-sm-auto  ">
        <a href="<?php echo e(route($client_keyword.'projects.bug.report',[$currentWorkspace->slug,$project->id])); ?>" class="btn btn-xs btn-primary btn-icon-only width-auto"><?php echo e(__('Bug Report')); ?></a>
         </div>
    <?php endif; ?>
    <div class="col-sm-auto ">
    <a href="<?php echo e(route($client_keyword.'projecttime.tracker',[$currentWorkspace->slug,$project->id])); ?>" class="btn btn-xs btn-primary btn-icon-only width-auto "><?php echo e(__('Tracker')); ?></a>
     </div>
<?php $__env->stopSection(); ?>
<style type="text/css">
    .fix_img{
                ...
                <div class="row">
                                     ...
                                     <h4 class="text-white">  <?php echo e($project->name); ?></h4>
                                            ...
                                            <div class="d-flex align-items-center ">
                                             <button class="btn btn-light d-flex align-items-between me-3"> 
                                                <a href="#" class="" data-url="<?php echo e(route('projects.edit',[$currentWorkspace->slug,$project->id])); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Edit Project')); ?>" data-toggle="popover" title="<?php echo e(__('Edit')); ?>">
                                                            <i class="ti ti-edit"> </i>
                                                        </a>
                                               </button>
                                            <button class="btn btn-light d"><a href="#" class="bs-pass-para"  data-confirm="<?php echo e(__('Are You Sure?')); ?>" data-text="<?php echo e(__('This action can not be undone. Do you want to continue?')); ?>" data-confirm-yes="delete-form-<?php echo e($project->id); ?>" data-toggle="popover" title="<?php echo e(__('Delete')); ?>"><i class="ti ti-trash"> </i></a></button>
                                            ...
                                            <?php echo method_field('DELETE'); ?>
                                             ...
                                             <?php else: ?>
                                              ...
                                              <button class="btn btn-light d"> <a href="#" class="bs-pass-para" data-confirm="<?php echo e(__('Are You Sure?')); ?>" data-text="<?php echo e(__('This action can not be undone. Do you want to continue?')); ?>" data-toggle="popover" title="<?php echo e(__('Delete')); ?>"  data-confirm-yes="leave-form-<?php echo e($project->id); ?>"><i class="ti ti-trash"> </i> </i></a></button>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                             ...
                             <div class="float-end">
                                    <p class="text-muted d-sm-flex align-items-center mb-0"> <?php if($currentWorkspace->permission == 'Owner'): ?>
                                                <a href="#" class="btn btn-sm btn-primary " data-ajax-popup="true" data-title="<?php echo e(__('Invite')); ?>" data-toggle="popover" title="<?php echo e(__('Invite')); ?>"  data-url="<?php echo e(route('projects.invite.popup',[$currentWorkspace->slug,$project->id])); ?>"><i class="ti ti-brand-telegram"></i></a>
                                            <?php endif; ?> </p>
                                </div>
                                 </div>
                            </div>  
                                            ...
                                            <div class="col-sm-auto mb-3 mb-sm-0">
                                                <div class="d-flex align-items-center px-2">
                                                   <a href="#" class=" text-start">
                                                        <img  class="fix_img" <?php if($user->avatar): ?> src="<?php echo e(asset('/storage/avatars/'.$user->avatar)); ?>" <?php else: ?> avatar="<?php echo e($user->name); ?>" <?php endif; ?>>
                                                    </a>
                                                    <div class="px-2">
                                                        <h5 class="m-0"><?php echo e($user->name); ?></h5>
                                                        <small class="text-muted"><?php echo e($user->email); ?><span class="text-primary ">  - <?php echo e((int) count($project->user_done_tasks($user->id))); ?>/<?php echo e((int) count($project->user_tasks($user->id))); ?></span></small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-auto text-sm-end d-flex align-items-center">
                                                     <?php if(auth()->guard('web')->check()): ?>
                                                        <?php if($currentWorkspace->permission == 'Owner' && $user->id != Auth::id()): ?>
                                                            <a href="#" class="action-btn btn-primary mx-1  btn btn-sm d-inline-flex align-items-center" data-ajax-popup="true" data-size="lg" data-toggle="popover" title="<?php echo e(__('Permission')); ?>" data-title="<?php echo e(__('Edit Permission')); ?>"  data-url="<?php echo e(route('projects.user.permission',[$currentWorkspace->slug,$project->id,$user->id])); ?>" ><i class="ti ti-lock"></i></a>

                                                            <a href="#" class="action-btn btn-danger btn btn-sm d-inline-flex align-items-center bs-pass-para"  data-confirm="<?php echo e(__('Are You Sure?')); ?>" data-toggle="popover" title="<?php echo e(__('Delete')); ?>" data-text="<?php echo e(__('This action can not be undone. Do you want to continue?')); ?>" data-confirm-yes="delete-user-<?php echo e($user->id); ?>"><i class="ti ti-trash ml-1"></i></a>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                             ...
                             <div class="float-end">
                                    <p class="text-muted d-none d-sm-flex align-items-center mb-0"> <?php if($currentWorkspace->permission == 'Owner'): ?>
                                                <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true"  data-title="<?php echo e(__('Share to Client')); ?>" data-toggle="popover" title="<?php echo e(__('Share to Client')); ?>" data-url="<?php echo e(route('projects.share.popup',[$currentWorkspace->slug,$project->id])); ?>"><i class="ti ti-share"></i></a>
                                            <?php endif; ?> </p>
                                </div>
                                 </div>
                          </div>
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row align-items-center justify-content-between">
                                            <div class="col-sm-auto mb-3 mb-sm-0">
                                                <div class="d-flex align-items-center px-2">
                                                   <a href="#" class=" text-start">
                                                        <img  class="fix_img" <?php if($client->avatar): ?> src="<?php echo e(asset('/storage/avatars/'.$client->avatar)); ?>" <?php else: ?> avatar="<?php echo e($client->name); ?>"<?php endif; ?>>
                                                    </a>
                                                    <div class="px-2">
                                            ...
                                            <div class="col-sm-auto text-sm-end d-flex align-items-center">
                                                     <?php if(auth()->guard('web')->check()): ?>
                                                        <?php if($currentWorkspace->permission == 'Owner'): ?>
                                                            <a href="#" class="action-btn btn-primary mx-1  btn btn-sm d-inline-flex align-items-center" data-toggle="popover" title="<?php echo e(__('Permission')); ?>"  data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Edit Permission')); ?>" data-url="<?php echo e(route('projects.client.permission',[$currentWorkspace->slug,$project->id,$client->id])); ?>"><i class="ti ti-lock"></i></a>

                                                            <a href="#" class="action-btn btn-danger mx-1  btn btn-sm d-inline-flex align-items-center bs-pass-para" data-confirm="<?php echo e(__('Are You Sure?')); ?>" data-toggle="popover" title="<?php echo e(__('Delete')); ?>" data-text="<?php echo e(__('This action can not be undone. Do you want to continue?')); ?>" data-confirm-yes="delete-client-<?php echo e($client->id); ?>"><i class="ti ti-trash"></i></a>
                    ...
                    <div class="col-xxl-4">
                     ...
                     <div class="col-md-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="row">
                                    <h5 class="mb-0"><?php echo e(__('Progress')); ?><span class="text-end">  (Last Week Tasks) </span></h5>
                                    ...
                                    <?php $__currentLoopData = $project->activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="timeline-block px-2 pt-3">
                                            <?php if($activity->log_type == 'Upload File'): ?>
                                                <span class="timeline-step timeline-step-sm border border-primary text-white"> <i class="fas fa-file"></i></span>
                                            <?php elseif($activity->log_type == 'Create Milestone'): ?>
                                                <span class="timeline-step timeline-step-sm border border-info text-white"> <i class="fas fa-cubes"></i></span>
                                            <?php elseif($activity->log_type == 'Create Task'): ?>
                                                <span class="timeline-step timeline-step-sm border border-success text-white"> <i class="fas fa-tasks"></i></span>
                                            <?php elseif($activity->log_type == 'Create Bug'): ?>
                                                <span class="timeline-step timeline-step-sm border border-warning text-white"> <i class="fas fa-bug"></i></span>
                                            <?php elseif($activity->log_type == 'Move' || $activity->log_type == 'Move Bug'): ?>
                                                <span class="timeline-step timeline-step-sm border round border-danger text-white"> <i class="fas fa-align-justify"></i></span>
                                            <?php elseif($activity->log_type == 'Create Invoice'): ?>
                                                <span class="timeline-step timeline-step-sm border border-bg-dark text-white"> <i class="fas fa-file-invoice"></i></span>
                                            <?php elseif($activity->log_type == 'Invite User'): ?>
                                                <span class="timeline-step timeline-step-sm border border-success text-white"> <i class="fas fa-plus"></i></span>
                                            <?php elseif($activity->log_type == 'Share with Client'): ?>
                                                <span class="timeline-step timeline-step-sm border border-info text-white"> <i class="fas fa-share"></i></span>
                                            <?php elseif($activity->log_type == 'Create Timesheet'): ?>
                                                <span class="timeline-step timeline-step-sm border border-success text-white"> <i class="fas fa-clock-o"></i></span>
                                            <?php endif; ?>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                         ...
                                         <div class="float-end">
                                            <?php if((isset($permissions) && in_array('create milestone',$permissions)) || $currentWorkspace->permission == 'Owner'): ?>
                                                <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-title="<?php echo e(__('Create Milestone')); ?>" data-url="<?php echo e(route($client_keyword.'projects.milestone',[$currentWorkspace->slug,$project->id])); ?>" data-toggle="popover" title="<?php echo e(__('Create')); ?>"><i class="ti ti-plus"></i></a>
                                            <?php endif; ?>
                                            </div>
                                        </div>
                                   </div>
                                    ...
                                    <div class="table-responsive">
                                            <table id="" class="table table-bordered px-2">
                                               ...
                                               <?php $__currentLoopData = $project->milestones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><a href="#" class="d-block font-weight-500 mb-0" data-ajax-popup="true" data-title="<?php echo e(__('Milestone Details')); ?>" data-url="<?php echo e(route($client_keyword.'projects.milestone.show',[$currentWorkspace->slug,$milestone->id])); ?>">
                                                        ...
                                                        <td> <?php if($milestone->status == 'complete'): ?>
                                                            ...
                                                            <td><?php echo e((!empty($currentWorkspace->currency)) ? $currentWorkspace->currency : '$'); ?><?php echo e($milestone->cost); ?></td>
                                                            <td> <div class="progress_wrapper">
                                                       <div class="progress">
                                                          <div class="progress-bar" role="progressbar"  style="width: <?php echo e($milestone->progress); ?>;"
                                                       ...
                                                       <div class="progress_labels">
                                                        ...
                                                        <td class="text-right">
                                                                 <div class="col-auto">
                                                        <?php if($currentWorkspace->permission == 'Owner'): ?>
                                                            <a href="#" class="action-btn btn-info mx-1  btn btn-sm d-inline-flex align-items-center" data-ajax-popup="true" data-size="lg" data-toggle="popover" title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Edit Milestone')); ?>" data-url="<?php echo e(route('projects.milestone.edit',[$currentWorkspace->slug,$milestone->id])); ?>"><i class="ti ti-edit"></i></a>
                                                            <a href="#" class="action-btn btn-danger mx-1  btn btn-sm d-inline-flex align-items-center bs-pass-para" data-confirm="<?php echo e(__('Are You Sure?')); ?>" data-toggle="popover" title="<?php echo e(__('Delete')); ?>" data-text="<?php echo e(__('This action can not be undone. Do you want to continue?')); ?>" data-confirm-yes="delete-form1-<?php echo e($milestone->id); ?>"><i class="ti ti-trash"></i></a>
                                                        ...
                                                        <?php elseif(isset($permissions)): ?>
                                                            <?php if(in_array('edit milestone',$permissions)): ?>
                                                                <a href="#" class="action-btn btn-info mx-1  btn btn-sm d-inline-flex align-items-center bs-pass-para" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Edit Milestone')); ?>" data-toggle="popover" title="<?php echo e(__('Edit')); ?>" data-url="<?php echo e(route($client_keyword.'projects.milestone.edit',[$currentWorkspace->slug,$milestone->id])); ?>"><i class="ti ti-edit"></i></a>
                                                            <?php endif; ?>
...
<script>
    ...
    <script src="<?php echo e(asset('custom/js/dropzone.min.js')); ?>"></script>
        ...
        dropzoneBtn(mockFile, {download: "<?php echo e(route($client_keyword.'projects.file.download',[$currentWorkspace->slug,$project->id,$file->id])); ?>", delete: "<?php echo e(route($client_keyword.'projects.file.delete',[$currentWorkspace->slug,$project->id,$file->id])); ?>"});

        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </script>

<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/werberson/Web/projetos/task/resources/views/projects/show.blade.php ENDPATH**/ ?>