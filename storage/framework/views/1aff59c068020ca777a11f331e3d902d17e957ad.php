                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            ...
                                                            <div class="theme-color themes-color">
                                                             <input type="hidden" class="theme_color " name="theme_color" value="<?php echo e($color); ?>">
                                                        ...
                                                        <div class="col-12 d-flex justify-content-between">
                                                            ...
                                                            <small class="">
                                                                <?php echo e(__('Note: This detail will use for make checkout of plan.')); ?></small>
                                                                   ...
                                                                   <div class="form-check form-switch d-inline-block">
                                                                                <input type="checkbox" class="form-check-input" name="is_coingate_enabled" id="is_coingate_enabled" <?php echo e(isset($payment_detail['is_coingate_enabled']) && $payment_detail['is_coingate_enabled'] == 'on' ? 'checked="checked"' : ''); ?>> <label class="custom-control-label form-control-label" for="is_mercado_enabled"><?php echo e(__('CoinGate')); ?></label>
                                                                            </div>            
                                                        </div>
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pb-4">
                                                        <div class="row pt-2">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/werberson/Web/projetos/task/resources/views/users/setting.blade.php ENDPATH**/ ?>