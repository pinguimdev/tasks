    ...
    <?php if(auth()->guard('web')->check()): ?>
        ...
        <?php if($currentWorkspace->creater->id == Auth::user()->id): ?>
                ...
                <i class="ti ti-edit"></i>
                  ...
                  <a href="#" class="btn btn-sm  mx-1 btn-primary cp_link " data-link="<?php echo e(route('pay.invoice',[$currentWorkspace->slug,\Illuminate\Support\Facades\Crypt::encrypt($invoice->id)])); ?>" data-toggle="tooltip" data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Copy')); ?>" data-original-title="<?php echo e(__('Click to copy invoice link')); ?>"><span class="btn-inner--icon text-white"></span><span class="btn-inner--text text-white"><i class="ti ti-copy"></i></span></a>
                        ...
                        <table class="table table-responsive invoice-table invoice-order table-borderless" >
                            <tbody style="padding-bottom: 0px  !important; font-size: 15px !important;">
                                <tr >
                                    ...
                                    <td style="padding-bottom: 0px  !important; font-size: 15px !important;"> <b><?php echo e(__('Project')); ?></b>  : <?php echo e($invoice->project->name); ?></td>
                                </tr>
                                <tr>
                            ...
                            <table class="table table-responsive invoice-table ">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo e($currentWorkspace->priceFormat($invoice->getSubTotal())); ?></td>
                                    </tr>
                                    ...
                                    <?php endif; ?>
                                     ...
                                     <tr>
                                            ...
                                            <td class="text-primary m-r-10 px-2"> <?php echo e($currentWorkspace->priceFormat($invoice->getDueAmount())); ?></td>
                                        </tr>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-icon-user">
                                            ...
                                            <input class="form-control currency_input" type="number" id="amount" name="amount" value="<?php echo e($invoice->getDueAmount()); ?>" min="0" step="0.01" max="<?php echo e($invoice->getDueAmount()); ?>" placeholder="<?php echo e(__('Enter Monthly Price')); ?>">
                                        </div>
                                    </div>
                                            ...
                                            <form method="post" action="<?php echo e(route('client.invoice.payment',[$currentWorkspace->slug,$invoice->id])); ?>" class="require-validation" id="payment-form">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="form-icon-user">
                                                            <span class="currency-icon bg-primary"><?php echo e((!empty($currentWorkspace->currency)) ? $currentWorkspace->currency : '$'); ?></span>
                                                            <input class="form-control currency_input" required="required" min="0" name="amount" type="number" value="<?php echo e($invoice->getDueAmount()); ?>" min="0" step="0.01" max="<?php echo e($invoice->getDueAmount()); ?>" id="amount">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
...
<?php if(auth()->guard('client')->check()): ?>
    <?php if($invoice->getDueAmount() > 0 && $currentWorkspace->is_stripe_enabled == 1 || $currentWorkspace->is_paypal_enabled == 1  || (isset($paymentSetting['is_paypal_enabled']) && $paymentSetting['is_paypal_enabled'] == 'on') || (isset($paymentSetting['is_paystack_enabled']) && $paymentSetting['is_paystack_enabled'] == 'on') || (isset($paymentSetting['is_flutterwave_enabled']) && $paymentSetting['is_flutterwave_enabled'] == 'on') || (isset($paymentSetting['is_razorpay_enabled']) &&
    $paymentSetting['is_razorpay_enabled'] == 'on') || (isset($paymentSetting['is_mercado_enabled']) && $paymentSetting['is_mercado_enabled'] == 'on') || (isset($paymentSetting['is_paytm_enabled']) && $paymentSetting['is_paytm_enabled'] == 'on') || (isset($paymentSetting['is_mollie_enabled']) && $paymentSetting['is_mollie_enabled'] == 'on') || (isset($paymentSetting['is_skrill_enabled']) && $paymentSetting['is_skrill_enabled'] == 'on') || (isset($paymentSetting['is_coingate_enabled']) && $paymentSetting['is_coingate_enabled'] == 'on')): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/werberson/Web/projetos/task/resources/views/invoices/show.blade.php ENDPATH**/ ?>