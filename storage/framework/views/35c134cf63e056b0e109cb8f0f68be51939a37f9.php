<?php if($project && $currentWorkspace): ?>
    ...
    <form class="" method="post" action="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('projects.bug.report.store',[$currentWorkspace->slug,$project->id])); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.projects.bug.report.store',[$currentWorkspace->slug,$project->id])); ?><?php endif; ?>">
        <?php echo csrf_field(); ?>
         <div class="modal-body">
            <div class="row">
            <div class="form-group col-md-8">
                <label class="col-form-label"><?php echo e(__('Title')); ?></label>
                <input type="text" class="form-control" id="task-title" placeholder="<?php echo e(__('Enter Title')); ?>" name="title" required>
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control select2" id="status" name="status" required>
                    <?php $__currentLoopData = $arrStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>"><?php echo e(__($status)); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
...
<?php endif; ?>
<?php /**PATH /Users/werberson/Web/projetos/task/resources/views/projects/bug_report_create.blade.php ENDPATH**/ ?>