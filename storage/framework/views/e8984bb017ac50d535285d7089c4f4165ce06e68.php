                ...
                <nav class="d-flex a;align-items-center justify-content-between">
                    ...
                    <div style="display: flex;">
                            ...
                            <?php if(!empty(Auth::user()->avatar)): ?>
                                <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;background-image: url('<?php echo e(asset('/storage/avatars/'.Auth::user()->avatar)); ?>');"></div>
                            <?php else: ?>
...
<?php endif; ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/werberson/Web/projetos/task/resources/views/vendor/Chatify/pages/app.blade.php ENDPATH**/ ?>