                                ...
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    <div data-v-f2a183a6="" class="d-header-50">
                                        <div data-v-f2a183a6="" class="d-header-brand">
                                            <img src="<?php if($currentWorkspace->logo): ?><?php echo e(asset(Storage::url('logo/'.$currentWorkspace->logo))); ?><?php else: ?><?php echo e(asset(Storage::url('logo/logo-light.png'))); ?><?php endif; ?>" style="max-width: 100px"/>
                                        </div>
...
<?php /**PATH /Users/werberson/Web/projetos/task/resources/views/invoices/template1.blade.php ENDPATH**/ ?>