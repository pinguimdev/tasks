        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-sm-5">
            ...
            <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
              ...
              >
              <a href="https://codecanyon.net/item/taskly-saas-project-management-tool/24490506" class="btn btn-outline-light" target="_blank"
...
<?php if(count($plans)>0): ?> 
          ...
          <div class="container">
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-lg-4 col-md-6">
                <div 
                  class="card price-card <?php echo e($price_class); ?> wow animate__fadeInUp"
                  data-wow-delay="0.2s"
                  style="
                    visibility: visible;
                    animation-delay: 0.2s;
                ...
                >
                  <div class="card-body">
                    <span class="price-badge <?php echo e($price_badge); ?>"><?php echo e($plan->name); ?></span>
                
                <span class="mb-4 f-w-600 p-price"><?php echo e((env('CURRENCY_SYMBOL')) ? env('CURRENCY_SYMBOL') : '$'); ?><?php echo e($plan->monthly_price); ?> <small class="text-sm">/<?php echo e(__('Monthly Price')); ?></small></span><br>
                 <span class="mb-4 f-w-600 p-price"><?php echo e((env('CURRENCY_SYMBOL')) ? env('CURRENCY_SYMBOL') : '$'); ?><?php echo e($plan->annual_price); ?> <small class="text-sm">/<?php echo e(__('Annual Price')); ?></small></span>
                   ...
                   <?php echo e(($plan->max_projects < 0)?__('Unlimited'):$plan->max_projects); ?> <?php echo e(__('Projects Per Workspace')); ?>
                    ...
                    <div class="d-grid text-center">
                      ...
                      <a href="<?php echo e(route('register')); ?>" 
                        class="btn mb-3 <?php echo e($price_btn); ?> d-flex justify-content-center align-items-center mx-sm-5"
                      >
        ...
        <div class="row align-items-center">
          ...
          <div class="col-xl-9 col-lg-6 col-md-12 col-sm-12">
            <div class="row feature-img-row m-auto">
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/images/plan.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.8s"
                  alt="Admin"
                />
  ...
  </style><?php /**PATH /Users/werberson/Web/projetos/task/resources/views/layouts/landing.blade.php ENDPATH**/ ?>