      ...
      <div class="dash-mob-drp">
        <ul class="list-unstyled">
            ...
            <div class="dropdown-menu dash-h-dropdown drp-search drp-search-custom">
              <form class="form-inline mr-auto mb-0">
                   <div class="search-element">
                      ...
                      <!-- <button class="btn serach_icon" type="submit">
         ...
         <?php endif; ?>
                  ...
                  <form class="form-inline mr-auto mb-0">
                     <div class="search-element">
                        <input class="form-control" type="type here" placeholder="Search here" aria-label="Search">
                        <button class="btn serach_icon" type="submit">
          ...
          <li class="dropdown dash-h-item drp-company">
              <a
                ...
                aria-expanded="false"
              >
                 <img class="theme-avtar"<?php if(Auth::user()->avatar): ?> src="<?php echo e(asset('/storage/avatars/'.Auth::user()->avatar)); ?>" <?php else: ?> avatar="<?php echo e(Auth::user()->name); ?>" <?php endif; ?> alt="<?php echo e(Auth::user()->name); ?>">
              ...
              <div class="dropdown-menu dash-h-dropdown">
                ...
                <a href="#" class="dropdown-item" title="<?php echo e(__('Locked')); ?>">
                 ...
                 <?php if(isset($workspace->pivot->permission)): ?>
                    <?php if($workspace->pivot->permission =='Owner'): ?>
                        <span class="badge badge-success-primary"><?php echo e(__($workspace->pivot->permission)); ?></span>
                    <?php else: ?>
                        <span class="badge bg-dark"><?php echo e(__('Shared')); ?></span>
                    <?php endif; ?>
                  <?php endif; ?>
              ...
              <?php if(isset($currentWorkspace) && $currentWorkspace): ?>
               <?php if(auth()->guard('web')->check()): ?>
                <?php if(Auth::user()->id == $currentWorkspace->created_by ): ?>
                   <a href="#" class="dropdown-item bs-pass-para" data-confirm="<?php echo e(__('Are You Sure?')); ?>" data-text="<?php echo e(__('This action can not be undone. Do you want to continue?')); ?>" data-confirm-yes="remove-workspace-form">
            ...
            <?php endif; ?>
                ...
                <?php endif; ?>
                <?php endif; ?> -->
                 <a href="#" class="dropdown-item "onclick="event.preventDefault();document.getElementById('logout-form1').submit();">
...
<?php endif; ?>
                 ...
                 <a
                  ...
                  <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                    ...
                    <a href="<?php echo e(route('change_lang_workspace1',[$currentWorkspace->id,$lang])); ?>" class="dropdown-item <?php echo e($currantLang == $lang ? 'text-danger' : ''); ?>">
                    ...
                    <?php if(\Auth::user()->type == 'admin'): ?>
                      <?php $__currentLoopData = \App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <a href="<?php echo e(route('change_lang_admin', $lang)); ?>" class="dropdown-item <?php echo e($currantLang == $lang ? 'text-danger' : ''); ?>">
                          <span><?php echo e(Str::upper($lang)); ?></span>
                        </a>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php elseif(isset($currentWorkspace) && $currentWorkspace): ?>
                      <?php $__currentLoopData = $currentWorkspace->languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <a href="<?php echo e(route('change_lang_workspace',[$currentWorkspace->id,$lang])); ?>" class="dropdown-item <?php echo e($currantLang == $lang ? 'text-danger' : ''); ?>">
                      <span><?php echo e(Str::upper($lang)); ?></span>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                    </a>
...
<?php /**PATH /Users/werberson/Web/projetos/task/resources/views/partials/topnav.blade.php ENDPATH**/ ?>